  ...
  return (
    <section id="sponsors" className=" py-12 ">
      <div className="flex flex-col container mx-auto px-4 text-center mt-10 md:mt-20 mb-20">
        <h1 className="text-3xl md:text-5xl font-extrabold font-[Roboto] drop-shadow-lg text-red-800 mb-5 uppercase">
          Sponsors
        </h1>
            ...
            {sponsors.map((sponsor) => (
              ...
              >
                <img
                  ...
                  className="w-full h-auto md:h-96 object-cover rounded-md"
