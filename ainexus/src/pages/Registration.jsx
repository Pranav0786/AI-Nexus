...
export const Registration = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('https://ai-nexus-997m.onrender.com/api/v1/register', {
        method: 'POST',
        body: formDataToSend,
      });
      ...
      if (result.success) {
        ...
        setModalMessage('Registration was successful! We are excited to see you at the event!');
        setIsModalOpen(true);
        setFormData({
